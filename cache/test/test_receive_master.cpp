//
// Created by Aboriginer on 12/12/2021.
//
...
int main(int argc, char *argv[])
{
    ...
    while (true) {
        std::cout << "Master start send message, fd = " << clientfd << std::endl;

        int len = recv(clientfd, recv_buff, BUF_SIZE, 0);

        std::cout << "Heartbeat:" << recv_buff << std::endl;
